...
<template>
  <div class="unitDetails">
    ...
    <div id="content" class="unitDetails--title">
      <img src="~/static/img/doubleRight.png" alt="">
      <h2>帳號明細</h2>
    </div>

    <div class="unitDetails_element">
      ...
      <div class="appealContent">
        ...
        <div class="appealContent_table">
          ...
          <div class="item">
            ...
            <div class="item_right">
              <p>{{ closeDiv(form.feature)!==false?form.feature + form.featureName: '-' }}</p>
            </div>
          </div>
          <div class="item">
            <div class="item_left">
          ...
          <div class="item">
            ...
            <div class="item_right">
              <p>{{ closeDiv(form.positionTitle)!==false?form.positionTitle: '-' }}</p>
            </div>
          </div>
          <div class="item">
            <div class="item_left">
      ...
      <div class="unitDetails_element--btn">
  ...
  methods: {
    async acctSelect () {
      ...
      if (res.isSuccess === true) {
        ...
        vm.form.featureName = data.featureName
    ...
    async submitForm (oldData) {
      ...
      const obj = {
        ...
        positionTitle: vm.closeDiv(oldData.positionTitle) !== false ? oldData.positionTitle : '',
