<template>
  <div class="frontPage">
    ...
    <div class="frontPage_ph">
      ...
      <div class="frontPage_item">
        <FrontPageResetPass v-if="frontPagePh==0" />
...
export default {
  ...
  mounted () {
    const resetPass = this.$route.query.passToken
    if (this.closeDiv(resetPass) !== false) {
      this.resetPass = true
      sessionStorage.setItem('passToken', resetPass)
